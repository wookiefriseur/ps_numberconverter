#
# Module manifest for module 'NumberConverter'
#
...
FunctionsToExport = 'ConvertFrom-Binary', 'ConvertTo-Binary', 'ConvertFrom-Octal', 
               'ConvertTo-Octal', 'ConvertFrom-Hexadecimal', 'ConvertTo-Hexadecimal'
